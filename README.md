...
For example, you can link this library to [the storacle](https://github.com/metasound/storacle/) and save links to files as well as additional metadata.
